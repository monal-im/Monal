...
# transform body in an array of stripped strings
...
# sanity checks
if "The following app has been approved for distribution:" not in body:
    print("Wrong state mentioned in mail", file=sys.stderr)
    sys.exit(0)
