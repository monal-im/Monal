...
-(BOOL) isTLS13
{
    MLAssert([self streamStatus] == NSStreamStatusOpen, @"Stream must be open to call this method!", (@{@"streamStatus": @([self streamStatus])}));
...
-(NSData*) channelBindingData_TLSExporter
{
    ...
    return (NSData*)sec_protocol_metadata_create_secret_with_context(s_metadata, 24, "EXPORTER-Channel-Binding", 1, (uint8_t*)"", 32);
}
