...
- (void) setPassword:(NSString*) pass 
{
	...
	[self mySetObject:pass forKey:(id)kSecValueData]; 
}
...
- (NSString*) getPassword
{
	...
	if (keychainErr == noErr) {
		...
		toreturn=[keydata objectForKey:(id)kSecValueData];
...
- (id)init:(NSString*) accountno
{
    if ((self = [super init])) {
       ...
       [genericPasswordQuery setObject:accountno forKey:(id)kSecAttrAccount ];
        ...
        if (keychainErr == noErr) {
			...
			[keychainData setObject:accountno forKey:(id)kSecAttrAccount ];
