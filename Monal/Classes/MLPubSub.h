...
//activate/deactivate automatic data updates, handler: $$static_handler(xxx, $_ID(xmpp*, account), $_ID(NSString*, node), $_ID(NSString*, jid), $_ID(NSString*, type), $_ID(NSDictionary*, data))
...
//fetch data, handler: $$static_handler(xxx, $_ID(xmpp*, account), $_ID(NSString*, jid), $_ID(MLXMLNode*, errorIq), $_ID(NSDictionary*, data))
-(void) fetchNode:(NSString*) node from:(NSString*) jid withItemsList:(NSArray* _Nullable) itemsList andHandler:(MLHandler*) handler;

//configure node, handler: $$static_handler(xxx, $_ID(xmpp*, account), $_BOOL(success))
-(void) configureNode:(NSString*) node withConfigOptions:(NSDictionary*) configOptions andHandler:(MLHandler* _Nullable) handler;

//publish, handler: $$static_handler(xxx, $_ID(xmpp*, account), $_BOOL(success))
...
//retract, handler: $$static_handler(xxx, $_ID(xmpp*, account), $_BOOL(success))
...
//purge whole node, handler: $$static_handler(xxx, $_ID(xmpp*, account), $_BOOL(success))
-(void) purgeNode:(NSString*) node;
-(void) purgeNode:(NSString*) node andHandler:(MLHandler* _Nullable) handler;

//delete whole node, handler: $$static_handler(xxx, $_ID(xmpp*, account), $_BOOL(success))
