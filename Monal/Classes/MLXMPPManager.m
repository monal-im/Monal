...
-(void) defaultSettings
{
    ...
    //upgrade default omemo auto-trust behaviour
    [self upgradeBoolUserSettingsIfUnset:@"AutoTrustNewOmemoKeys" toDefault:YES];
...
#ifdef IS_QUICKSY
    NSNumber* oldValue = [[HelperTools defaultsDB] objectForKey:@"Quicksy_autogeneratedPassword"];
    [self removeObjectUserSettingsIfSet:@"Quicksy_autogeneratedPassword"];
    if(oldValue != nil)
        [self upgradeBoolUserSettingsIfUnset:@"autogeneratedPassword" toDefault:oldValue.boolValue];
    else
        [self upgradeBoolUserSettingsIfUnset:@"autogeneratedPassword" toDefault:YES];
#endif
    [self upgradeBoolUserSettingsIfUnset:@"autogeneratedPassword" toDefault:NO];
