...
class Quicksy_State: ObservableObject {
    ...
    @defaultsDB("autogeneratedPassword")
...
struct Quicksy_RegisterAccount: View {
    ...
    private func requestSMS(for number:String) {
        ...
        showPromisingLoadingOverlay(overlay, headline:"Requesting validation SMS...", description: "") {
    ...
    private func createAccount() {
        ...
        if let number = state.phoneNumber, let _ = state.country {
            showPromisingLoadingOverlay(overlay, headline:"Registering account...", description: "") {
